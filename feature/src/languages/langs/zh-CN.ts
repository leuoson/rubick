    ...
    feature: {
      ...
      settings: {
        ...
        ai: {
          ...
          quickAdd: '快速添加',
          providers: '已配置的提供商',
          noProviders: '暂无配置的 AI 提供商，请点击上方按钮添加',
          addProvider: '添加提供商',
          addCustomProvider: '添加自定义提供商',
          editProvider: '编辑提供商',
          deleteConfirm: '确定删除此提供商吗？',
          deleteConfirmMsg: '确定删除供应商 "{name}" 吗？',
          providerName: '提供商名称',
          ...
          disabled: '已禁用',
          localNoApiKey: '本地模型无需 API Key',
          azureResourceName: 'Azure 资源名称',
          azureResourceNameTip: 'Azure 资源名称，例如: your-resource-name.openai.azure.com',
        },
      },
      dev: {
        title: '开发者',
