    ...
    feature: {
      ...
      settings: {
        ...
        ai: {
          ...
          noProviders: 'No AI providers configured. Click the button above to add one.',
          addProvider: 'Add Provider',
          addCustomProvider: 'Add Custom Provider',
          editProvider: 'Edit Provider',
          deleteConfirm: 'Are you sure to delete this provider?',
          deleteConfirmMsg: 'Are you sure to delete provider "{name}"?',
          ...
          disabled: 'Disabled',
          localNoApiKey: 'No API Key required for local models',
          azureResourceName: 'Azure Resource Name',
          azureResourceNameTip: 'Azure resource name, e.g. your-resource-name.openai.azure.com',
        },
      },
      dev: {
        title: 'Developer',
